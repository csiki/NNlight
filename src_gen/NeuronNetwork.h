...
public: 
     ...
     * @param train_ratio
     */
    void train(const vector<vector<double>>& input, const vector<double>& desired_output, double train_ratio);
     ...
     * @param train_ratio
     */
    void train(istream& train_stream, double train_ratio);
     ...
     * @param input_stream
     */
    void test(istream& input_stream);
